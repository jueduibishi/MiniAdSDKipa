...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "yangyifan"
  # spec.authors            = { "yangyifan" => "yangyifan@4399inc.com" }
  # spec.social_media_url   = "https://twitter.com/yangyifan"
  ...
  spec.vendored_frameworks = "mini/MiniSDKFramework.framework"
